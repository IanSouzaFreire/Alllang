...
procedure Update (M : in out MovableObject; DeltaTime : in Float) is
begin
...
procedure Turn (C : in out Car; Angle : in Float) is
begin
   C.TurnAngle := C.TurnAngle + Angle;
end Turn;

procedure Update (C : in out Car; DeltaTime : in Float) is
begin
